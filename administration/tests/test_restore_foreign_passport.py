...
from passports.models import Visa, ForeignPassport
from rest_framework import status
from rest_framework.test import APITestCase
from unittest.mock import ANY


class RestoreForeignPassportByStaffAPITests(APITestCase):
    def setUp(self):
        self.path =  "/api/staff/restore-foreign-passport/"
        ...
        self.foreign_passport = ForeignPassportFactory(photo='')
        self.visa = VisaFactory(foreign_passport=self.foreign_passport)
        ...
        self.task_passport_loss = TaskFactory(user=self.user,
                                title="restore a foreign passport due to loss",
                                status=0,
                                user_data={
                                    "photo": "1-surname22-name22-restore-a-foreign-passport.jpg"
                                }
       )
        self.task_passport_expiry = TaskFactory(user=self.user,
                                title="restore a foreign passport due to expiry",
                                status=0,
                                user_data={
                                    "photo": "1-surname22-name22-restore-a-foreign-passport.jpg"
                                }
    ...
    def test_restore_foreign_passport_loss_successful(self):
        ...
        check_old_passport = ForeignPassport.objects.filter(number=self.foreign_passport.number).exists()
        self.assertFalse(check_old_passport)
        self.assertEqual(self.task_passport_loss.status, 1)

    def test_restore_foreign_passport_expiry_successful(self):
        response = self.client.put(
    ...
    def test_restore_foreign_passport_user_doesnt_have_foreign_passport(self):
    ...
    def test_restore_foreign_passport_task_already_processed(self):
    ...
    def test_restore_foreign_passport_wrong_task(self):
        response = self.client.put(
    ...
    def test_restore_foreign_passport_without_authority(self):
        response = self.client.put(
            path=f"{self.path}{self.task_passport_expiry.pk}/",
            data={
	        "date_of_issue": self.valid_data['date_of_issue'],
    ...
    def test_restore_foreign_passport_authority_incorrect(self):
        response = self.client.put(
            path=f"{self.path}{self.task_passport_expiry.pk}/",
            data={
                "authority": 10,
    ...
    def test_restore_foreign_passport_date_format_incorrect(self):
        response = self.client.put(
            path=f"{self.path}{self.task_passport_expiry.pk}/",
            data={
                "authority": self.valid_data['authority'],
    ...
    def test_restore_foreign_passport_date_of_issue_incorrect(self):
        response = self.client.put(
            path=f"{self.path}{self.task_passport_expiry.pk}/",
            data={
                "authority": self.valid_data['authority'],
    ...
    def test_restore_foreign_passport_date_of_expiry_incorrect(self):
        response = self.client.put(
            path=f"{self.path}{self.task_passport_expiry.pk}/",
            data={
                "authority": self.valid_data['authority'],
    ...
    def test_restore_foreign_passport_no_data(self):
    ...
    def test_restore_foreign_passport_task_not_found(self):
    ...
    def test_restore_foreign_passport_user_no_access(self):
