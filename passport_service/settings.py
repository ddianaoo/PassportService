"""
Django settings for passport_service project.
...
ROOT_URLCONF = 'passport_service.urls'
...
WSGI_APPLICATION = 'passport_service.wsgi.application'
...
FORMATTERS = {
    ...
    "simple": {
        "format": "[{asctime:s}] {levelname} {filename} {lineno:d} {message}",
        "style": "{",
    },
}
...
HANDLERS = {
    ...
    "my_handler": {
        ...
        "filename": f"{BASE_DIR}/logs/passport_service.log",
        "mode": "a",
        "encoding": "utf-8",
        "formatter": "simple",
        "backupCount": 5,
    ...
    "my_handler_detailed": {
        "class": "logging.handlers.RotatingFileHandler",
        "filename": f"{BASE_DIR}/logs/passport_service_detailed.log",
        "mode": "a",
        "formatter": "verbose",
        "backupCount": 5,
        "maxBytes": 1024 * 1024 * 5,  # 5 MB
